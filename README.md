...
│   ├── 学术脚手架/              # 学术科研工具箱（论文/基金/学位/文献/生信/古籍/Office 等 14 技能）
│   │   ├── CLAUDE.md
│   │   ├── AGENTS.md
│   │   ├── GEMINI.md
│   │   ├── .claude/             # Claude Code（14 commands + 各技能 skills/scripts）
│   │   ├── .codex/              # Codex 技能包（14 skills）
│   │   └── .gemini/             # Gemini CLI 技能包（14 skills）
...
| **学术脚手架** | 论文精读、期刊投稿、国自然/学位论文、文献与深研、PDF 预处理、PubMed、生信、医学循证、古籍采集、**Office 文档（DOCX/PPTX/XLSX）** | 科研与写作工具箱：paper-reader、paper-submission-manager、sci-journal-submission-expert、nsfc-proposal-advisor、thesis-writing-mentor、pubmed-linker、extract、dr-midas、scrna-celltype-annotation、pdf-reader、deep-research、shidianguji-fetcher、medical-advisory、**office-docs**；不含 Cursor 规则 |
...
| **学术科研脚手架 (学术脚手架)** | Claude + Codex + Gemini | 14 commands<br>多 skills | 14 skills | 14 skills | 论文/基金/学位/投稿、文献与深研、PDF、PubMed、生信、医学循证、古籍采集、**Office 文档**；适合课题组、医学与生命科学团队、人文文献项目 |
