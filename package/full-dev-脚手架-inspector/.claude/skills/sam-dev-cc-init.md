...
7. **检查完成**：使用 check-complete.sh 验证PDCO循环

## Token 动态预算管理

PDCO 工作流通过 **Token 预算等级** 约束任务成本，鼓励高效优质交付：
...
**自动调整规则：**
- 3×A 级 → 升级 → 享受更高预算
- 1×C 级或D级 → 降级 → 进入冷静期 3 次
- 周度复盘 → 更新 self.opt 效率趋势

## 奖惩机制

PDCO 工作流内置积分激励机制，鼓励高质量交付与知识沉淀：

**奖励示例：**
- ✅ CHECKFIX 一次通过：+10 积分
- ✅ 任务零缺陷交付：+15 积分
- ✅ self.opt 经验分享：+3 积分/条
- ✅ Token 预估精准：+5 积分

**惩罚示例：**
- ❌ 跳过 CHECKFIX：-50 积分（直接打回）
- ❌ 生产 bug：-30 积分/个
- ❌ 不记录经验：-10 积分
- ❌ Token 预估严重偏离：-10 积分

**积分兑现：**
- 🟢 101+ 分：快速通道、任务优先权、Token 预算升级优先
- 🔴 <50 分：强制质量培训、二级审查、预算降级
