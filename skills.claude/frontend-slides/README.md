...
mkdir .claude/skills/frontend-slides/scripts

# Copy all files (or clone this repo directly)
cp SKILL.md STYLE_PRESETS.md viewport-base.css html-template.md animation-patterns.md .claude/skills/frontend-slides/scripts/
...
```bash
git clone https://github.com/zarazhangrui/frontend-slides.git .claude/skills/frontend-slides/scripts
```
