...
**Path conventions:**
- Supporting files are siblings of this `SKILL.md` at the skill root.
- Script at `scripts/extract-pptx.py` relative to skill root.
- Canonical script source lives in the Codex mirror: `skills.codex/frontend-slides/scripts/extract-pptx.py`.
